...
function getRectangleString(width, height) {
  const topLeftAngle = String.fromCharCode(0x250C);
  const topRightAngle = String.fromCharCode(0x2510);
  const bottomLeftAngle = String.fromCharCode(0x2514);
  const bottomRightAngle = String.fromCharCode(0x2518);
  const horizontalLine = String.fromCharCode(0x2500);
  const verticalLine = String.fromCharCode(0x2502);

  const side = horizontalLine.repeat(width - 2);
  const space = ' '.repeat(width - 2);

  const top = `${topLeftAngle}${side}${topRightAngle}\n`;
  const middle = `${verticalLine}${space}${verticalLine}\n`;
  const bottom = `${bottomLeftAngle}${side}${bottomRightAngle}\n`;
